    ...
    return(
        ...
        <div className="h-200 bg-gray-50 ">
            <div className="absolute left-110">
                <div className="font-bold text-3xl"><p>Huge Global Network</p></div>
                <div className="font-bold text-3xl ml-15"><p>of Fast VPN</p></div>
            </div>
             <div className="absolute mt-26 left-85">
