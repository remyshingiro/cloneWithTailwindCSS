    ...
    return(
        <>
            <div class="w-37 h-9 absolute top-12 left-37">
                <img src="public/assets/1.png" class="w-9 h-9 absolute top-12 left-38"></img>
            ...
            <section>
                ...
                <a href="#" class="w-11 h-5 absolute top-14 left-218 font-['Rubik'] font-normal text-base leading-[100px] tracking-normal">Help</a>
                <a href="#" class="w-13 h-5 absolute top-14 left-264 font-['Rubik'] font-normal text-base leading-[100px] tracking-normal">Sign In</a>
                <button class="w-38 h-11 absolute top-20 left-285  rounded-[50px] border-red-900">Sign Up</button>
            </section>
